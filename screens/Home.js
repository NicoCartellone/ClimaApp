        ...
        <Container>
            ...
            <View style={styles.buscadorContainer}>
                <View style={styles.containerBtnInput}>
                    <TextInput
                        ...
                        value={search}
                        placeholder="Busque entre sus ciudades"
                    ...
                    />
                    <MaterialCommunityIcons style={styles.btnBuscar} name="magnify" color={"#666"} size={28}></MaterialCommunityIcons>
                </View>
            </View>
            <View style={styles.contain}>
                        ...
                        <View style={styles.flatListContainer}>
                            ...
                            <View style={styles.containerBtns}>
                                <TouchableOpacity
                                    ...
                                    <MaterialCommunityIcons name="delete" color={"#c94934"} size={28}></MaterialCommunityIcons>

                                </TouchableOpacity>
                                <TouchableOpacity
                                    style={styles.btnBuscador}
                                    onPress={() => navigation.navigate('Details', item)}>
                                    <MaterialCommunityIcons name="plus-box-multiple" color={"#5B5A5A"} size={28}></MaterialCommunityIcons>
                                </TouchableOpacity>
                            </View>
                        </View>
                    )}
                ...
                <TouchableOpacity
                    ...
                    <MaterialCommunityIcons name="plus" color={"#51608F"} size={40}></MaterialCommunityIcons>
                </TouchableOpacity>
            </View>
        </Container>
    )
